            ...
            <li ref={servicesDropdownRef}>
                ...
                {isServicesDropdownOpen && (
                    <ul className="w-48 md:absolute md:mt-10 bg-white shadow-lg rounded-lg">
                        <li><a href='/PeoEor'>{t('PEO&EoR')}</a></li>
                        <li><a href='/recuritment'>{t('Recruitment')}</a></li>
                        <li><a href='/hrConsulting'>{t('HR Consulting')}</a></li>
                        <li><a href='/managedServices'>{t('Managed Services')}</a></li>
                    </ul>
                )}
            </li>
