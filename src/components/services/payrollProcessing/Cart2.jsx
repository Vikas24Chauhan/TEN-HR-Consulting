      ...
      <div className="content-wrapper">
        <div className="features-grid">
          ...
          <div className="feature-box gray">
            ...
            <p>
              Our robust systems for data management and security will ensure
          ...
          <div className="feature-box blue">
            ...
            <p>
              Our locally based team is on hand to handle any customer support
              issues. We aim to resolve 90% of all issues within 24 hours and
              have a strong track record and reputation with our clients.
            </p>
          </div>
        </div>
        <div className="dashboard-image">
          <img
            src="https://recruitindo.com/wp-content/uploads/2023/12/more-than-payroll.png"
            alt="Dashboard"
          />
        </div>
      </div>
